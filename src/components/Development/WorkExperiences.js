    ...
    return (
        <div className="work-experiences">
            ...
            <div className="work-experience">
                ...
                <p className="work-experience__description">Ekstrahjelp på trelast avd.</p>
            ...
            <div className="work-experience">
                ...
                <p className="work-experience__description">Ekstrahjelp og sesong medarbeider på trelast</p>
