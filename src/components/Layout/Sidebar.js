            ...
            <nav className="nav">
                <ul className="nav__list">
                    <li className="nav__item nav__item--active">
                        <a href="#portfolio" className="nav__link"><i className="fas fa-palette"></i> Portfolio</a>
                    </li>
                    <li className="nav__item">
                        <a href="#about" className="nav__link"><i className="fas fa-user"></i> about</a>
                    </li>
                    <li className="nav__item">
                        <a href="#contact" className="nav__link"><i className="fas fa-envelope"></i> contact</a>
                    </li>
                </ul>
            </nav>
