...
const projects: IProjects[] = [
  {
    ...
    name: 'Re-Cycle',
    description:
      'Re-Cycle is a fictional tourist group in Risør, Norway that offer eco-friendly, guided cycling tours. The project was created to display what I have learned during the "HTML & CSS" course early in my studies. The project has been reworked in the spring of 2020.',
    ...
    school: {
      ...
      grade: '10 / 10',
      brief:
        'The goal of this project was to get used to coding for mobile first with only using HTML and CSS.',
    },
    functionalities: [
      'Responsive layout',
  ...
  },
  {
    ...
    description:
      'This project was created to showcase my abilities during the Project Exam 1, that took place in spring of 2020.',
    thumbnail: 'https://www.tonnessen.com/assets/spacex.jpg',
    link: 'https://www.tonnessen.com/noroff/feu/project-exam-1/',
    github:
      'https://github.com/Emizzari/24-05-2020_project-exam-1_emilie-tonnessen',
    school: {
      course: 'Project Exam 1',
      grade: 'B',
      brief:
        'The goal was to create a microsite for SpaceX/NASA to raise awareness about space program activity around the world. I chose to focus on SpaceX and display information about their launches.',
    },
    functionalities: [
      'SpaceX API',
    ...
    languages: [{ name: 'HTML' }, { name: 'SASS' }, { name: 'JavaScript' }],
  },
  {
    id: 3,
    focus: false,
    ...
    description:
      'Varus Cosmetics is a fictional makeup store created to showcase my abilities during the Semester Project 2, that took place in late autumn 2020.',
    ...
    school: {
      ...
      grade: 'A',
      brief:
        'The goal with Semester Project 2 was to create an e-commerce website that has both customer-facing and admin sections, that is populated by a Strapi API supplied by Noroff. We could choose our own theme as long as it followed the brief. I chose a makeup brand that I called Varus Cosmetics. Its target audience was teenage girls and young women with an ambition to find their own style.',
    },
    functionalities: [
  ...
  },
  {
    ...
    name: 'Trillo',
    description:
      'Trillo was created to follow the course "Advanced CSS and Sass", and specially learning advanced form of using Flexbox.',
    ...
    functionalities: ['Flexbox', 'Responsive Layout', 'Beautiful Design!'],
    languages: [{ name: 'HTML' }, { name: 'SASS' }],
  },
  {
    id: 6,
...

  {
    ...
    name: 'Holidaze',
    description:
      'Holidaze is a fictional local tourism agency that displays all accommodations in Bergen, Norway. The project was created to showcase my abilities during the Project Exam 2, that took place in the spring of 2021. This was final exam of my studies as a Frontend Developer.',
    ...
    school: {
      ...
      grade: 'A',
      brief:
        'The goal for this assignment was to take all the skills learned over the past two years and take on an extensive project where the finished product should reflect my general development capabilities, in addition to visual and technical  skills.',
    },
    functionalities: [
      'Public API powered by Strapi and deployed with Heroku',
      'Featured Products',
  ...
  },
  {
    ...
    description:
      "Risør klatreklubb is an indoor Climbing Club located in Risør, Norway. They are an all inclusive Club with focus on sports enjoyment, community and good health. I've previously created their logo which they are currently using.",
    thumbnail: 'https://www.tonnessen.com/assets/risorklatreklubb.png',
    link: 'https://www.risorklatreklubb.no',
